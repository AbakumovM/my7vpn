...
class TextManager:
    ...
    def get_android_settings():
        return (
            ...
            '<a href="https://play.google.com/store/apps/details?id=org.amnezia.vpn">AmneziaVPN → Скачать в Play Market</a>\n\n'
    ...
    def get_computer_settings():
        return (
            ...
            '<a href="https://amnezia.org/ru/downloads">AmneziaVPN</a>\n\n'
            "2️⃣ <b>Установите и откройте приложение</b>\n\n"
            "<a>Разрешите необходимые доступы (если запрашивает).</a>\n\n"
            "3️⃣ <b>Получите конфигурацию VPN</b>\n\n"
            "<a>Админ пришлёт вам нужные настройки после проверки оплаты</a>\n\n"
    ...
    def get_settings_iphone():
        return (
            ...
            '<a href="https://apps.apple.com/ru/app/amnezia-vpn/id1548281345">1. AmneziaVPN → Скачать в App Store(если у вашего аккаунта регион не Россия)</a>\n'
            '<a href="https://apps.apple.com/ru/app/amneziawg/id6478942365">2. AmneziaWG → Скачать в App Store(если аккаунт из России)</a>\n'
            '<a href="https://apps.apple.com/ru/app/foxray/id6448898396">3. FoxRay → Скачать в App Store</a>\n'
            '<a href="https://apps.apple.com/ru/app/shadowrocket/id932747118">4. Shadowrocket → Скачать в App Store(платное, но лучшая скорость)</a>\n\n'
            "2️⃣ <b>Установите и откройте приложение</b>\n\n"
            "<a>Разрешите необходимые доступы (если запрашивает).</a>\n\n"
            "3️⃣ <b>Получите конфигурацию VPN</b>\n\n"
            "<a>Админ пришлёт вам нужные настройки после проверки оплаты</a>\n\n"
