    ...
    def get_instruction(platform: str) -> str:
        instructions = {
            "android_phone": (
                ...
                "━━━━━━━━━━━━━━━━━━\n"
                "⚠️ <b>Если Happ не работает</b>, попробуйте <b>Incy VPN</b>:\n"
                '<a href="https://play.google.com/store/apps/details?id=llc.itdev.incy">→ Google Play</a>\n'
                "Шаги подключения те же — вставьте ваш ключ подписки."
            ),
            "ios": (
